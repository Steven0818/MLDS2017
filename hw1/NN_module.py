...
def BiGRU(inputs,num_layers,num_hidden_neurons,output_size,dropout,activation,name,sequence_length=None,reuse=False):
	...
	if reuse:
		...
		return {'output':output, 'rnn_cell':[Multi_fGRUcell_withDropout, Multi_bGRUcell_withDropout]}
